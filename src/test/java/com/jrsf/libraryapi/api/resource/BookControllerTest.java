...
public class BookControllerTest {
    ...
    @Test
    @DisplayName("Deve retornar resource not found livro não existir")
    ...
    @Test
    @DisplayName("Deve retornar resource not found não encontrar um livro para deletar")
    ...
    public void updateBookTest() throws Exception{
        ...
        Book updatedBook = Book.builder().id(1).title("Meu Livro").author("Jess Jane").isbn("321").build();
    ...
    @Test
    @DisplayName("Deve retornar erro 404 livro inexistente")
