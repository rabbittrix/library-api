...
public class LoanServiceTest {
    ...
    @Test
    @DisplayName("Deve lançar um erro ao salvar um empréstimo de um livro já emprestado")
    ...
    @Test
    @DisplayName("Deve atualizar um emprestimo de livro")
    ...
    @Test
    @DisplayName("Deve filtrar emprestimos de livros pelas propriedades")
    public void findLoanTest(){

        LoanFilterDTO loanFilterDTO = LoanFilterDTO.builder().customer("Jessica").isbn("321").build();
